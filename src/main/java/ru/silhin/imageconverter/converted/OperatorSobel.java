...
public class OperatorSobel implements IConvertingProcess {
    ...
    public Image converting(Image originalImage) {
        ...
        final int[] xSobelMatrix = new int[]{-1, 0, 1, -2, 0, 2, -1, 0, 1};
        final int[] ySobelMatrix = new int[]{-1, -2, -1, 0, 0, 0, 1, 2, 1};
            ...
            for (int x = 1; x < originalImage.getWidth() - 1; ++x) {
                ...
                for (int i = y - 1; i <= y + 1; ++i) {
                    for (int j = x - 1; j <= x + 1; ++j) {
                        ...
                        rX += xSobelMatrix[index] * z.getRed();
                        gX += xSobelMatrix[index] * z.getGreen();
                        bX += xSobelMatrix[index] * z.getBlue();

                        rY += ySobelMatrix[index] * z.getRed();
                        gY += ySobelMatrix[index] * z.getGreen();
                        bY += ySobelMatrix[index] * z.getBlue();
